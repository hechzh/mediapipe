...
bazel-bin/mediapipe/examples/desktop/hand_tracking/hand_tracking_cpu_fps.exe --calculator_graph_config_file=mediapipe/graphs/hand_tracking/hand_detection_desktop_live.pbtxt --input_video_path=D:/video/pml.mp4
```
...
bazel-bin/mediapipe/examples/desktop/hand_tracking/hand_tracking_onnx_cuda_fps.exe --calculator_graph_config_file=mediapipe/graphs/hand_tracking/hand_detection_desktop_live_onnx_cuda.pbtxt --input_video_path=D:/video/pml.mp4
```
